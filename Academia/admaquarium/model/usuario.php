	...
	class Usuario
	{
		...
		function Cadastrar()
		{
			...
			$sql = "insert into usuario
					(nome,email,telefone,celular,imgficha,nomeusuario,senha,tipo) 
					values 
					(?,?,?,?,?,?,?,?)";

			//executando o comando sql e passando os valores
			$this->con->prepare($sql)->execute(array(
			$this->nome,$this->email,$this->telefone,$this->celular,$this->imgficha,$this->nomeusuario,
			$this->senha,$this->tipo));
		}
		...
		function Atualizar()
		{
			...
			$sql = "update usuario set
					nome = ?,email = ?,telefone = ?,celular = ?,imgficha = ?,nomeusuario = ?,
					senha = ?,tipo = ?
					where codusuario = ?";
		...
		function Atualizar_form()
		{
			//passando o comando sql
			$sql = "update usuario set
					nome = ?,email = ?,telefone = ?,celular = ?,tipo = ?
					where codusuario = ?";

			//executando o comando sql e passando os valores
			$this->con->prepare($sql)->execute(array(
			$this->nome,$this->email,$this->telefone,$this->celular,$this->tipo,
			$this->codusuario));
		}
