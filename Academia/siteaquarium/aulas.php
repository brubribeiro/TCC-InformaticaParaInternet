<?php
include_once("../admaquarium/controller/descricaoaula.controller.php");
...
<html class="no-js">
			...
			<header id="fh5co-header-section">
				<div class="container">
					<div class="nav-header">
						...
						<a href="inicio.html" class="logo"><img src="images/logo.png" width="250" height="150" alt=""></a>
	...
	<div id="fh5co-programs-section">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="heading-section text-center animate-box">
							<br>
							<br>
							<h2>Conheça nossas aulas</h2>
							<p>Confira abaixo uma breve descrição das nossas aulas, e escolha a melhor para você.</p>
						</div>
					</div>
				</div>
				...
				<?php
				foreach ($des->Consultar() as $linha):
				?>					

					<div class="col-md-4 col-sm-6">
						<div class="program animate-box">
							<img src="images/<?php echo $linha->imagemaula;?>">
							<h3><?php echo $linha->tituloaula;?></h3>
							<p><?php echo $linha->descricaoaula;?></p>
