					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li>
									<span>
										<a class="btn btn-primary2" href="../admaquarium/controller/sair.php"><font color="#1E90FF"><b>SAIR</b></a></span></font>
								</li>
								<?php } ?>
            ...
            <div class="col-lg-12">               
                    ...
                    <div class="panel-body">
                         ...
                         <div class="form-group">
                            <label>Nome</label>
                            <input type="text" name="nome" class="form-control" id="nome" placeholder="Informe seu nome" required value="<?php echo $usu->nome;?>">                                         
                        </div>

                         <div class="form-group">
                            <label>Email</label>
                            <input name="email" class="form-control" id="email" placeholder="Informe seu email" required value="<?php echo $usu->email;?>">                                           
                        </div> 

                        <div class="form-group">
                            <label>Telefone</label>
                            <input name="telefone" class="form-control" id="telefone" placeholder="Informe seu telefone" required value="<?php echo $usu->telefone;?>">                                           
                        </div>

                         <div class="form-group">
                            <label>Celular</label>
                            <input name="celular" class="form-control" id="celular" placeholder="Informe seu celular" required value="<?php echo $usu->celular;?>">                                           
                        </div>  
                        ...
                        <button type="reset" class="btn btn-primary">Limpar Campos</button>	<br><br>

                        <div class="row">
								<li>
									<a class="section-title" href="usuario.php">Voltar</a>
								</li>
							</div>													
                    </form>
                </div>                       
			...
			<div id="footer">
				...
				<div class="row copy-right">
					<div class="col-md-6 col-md-offset-3 text-center">
						...
						<a href="https://www.instagram.com/academia.aquariumfit/"><i class="icon-instagram"></i></a><a href="https://www.youtube.com/watch?v=Ce1B1DOT3RU"><i class="icon-youtube"></i></a>
						</p>
