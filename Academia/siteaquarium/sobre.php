				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell animate-box">
							...
							<font color="#B0E2FF" size=5px>Informações sobre a Academia Aquarium Fit
				...
				<div class="row about">
					...
					<div class="col-md-4 col-sm-4 fh5co-item-wrap">
						<a class="fh5co-listing-item">
							<!-- MISSÃO -->
							<div class="fh5co-listing-copy" style="margin: 8px;padding:8px;
							background-color: #F2F2F2">
								<center><h2><font color="#1E90FF">Missão</h2>
								</i><font size="5,2" color="#000000"><div align="justify">Proporcionar um atendimento de alta qualidade, oferecendo saúde, bem-estar e motivação em um ambiente agradável, familiar onde as pessoas criam amizades e praticam atividades físicas.</div> </font></p></tr>
					...
					<div class="col-md-4 col-sm-4 fh5co-item-wrap">
						<a class="fh5co-listing-item">
							...
							<div class="fh5co-listing-copy" style="margin: 8px;padding:8px;
							background-color: #F2F2F2">
								<center><h2><font color="#1E90FF">Visão</h2>
								</i><font size="5,2" color="#000000"><div align="justify">Ser reconhecida como a melhor academia da região de Caieiras e ser referência em atendimento na busca da boa forma e da saúde.</font></div>
								</span>
							</div>
						</a>
					</div>
					<div class="col-md-4 col-sm-4 fh5co-item-wrap" >
						<a class="fh5co-listing-item">
							...
							<div class="fh5co-listing-copy" style="margin: 8px;padding:8px;
							background-color: #F2F2F2">
								<center><h2><font color="#1E90FF">Valores</h2>
								</i><font size="5,2" color="#000000"><div align="justify">Compromisso com a Vida Saudável, Responsabilidade Social, Respeito ao Meio Ambiente, Qualidade, Praticidade, Satisfação do Cliente e Solução.</font></div>
								</span>
							</div>
						</a>
					</div>
